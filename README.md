...
- Пример из работы. Нужно было протестировать сервис создания интернет-магазинов и управления ими. Чек-лист в Miro, без привычных атрибутов, просто, чтобы не сбиться с пути.  [Ссылка на Miro](https://miro.com/app/board/uXjVN_4EC4g=/?share_link_id=642860102703)) 
